...
/* Generated from ../O.Common/traffic.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_trafficRegistrar, pvar_func_tsInitialize;
...
int traffic_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* traffic_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"traffic_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    traffic_registerRecordDeviceDriver(*iocshPpdbbase);
}
