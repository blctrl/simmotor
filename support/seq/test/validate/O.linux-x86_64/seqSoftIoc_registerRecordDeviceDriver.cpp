...
/* Generated from ../O.Common/seqSoftIoc.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_tsInitialize, pvar_func_register_func_subThreadSleep;
...
int seqSoftIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/blctrl/epics/apps/simmotor/support/seq";
    ...
    pvar_func_register_func_subThreadSleep();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* seqSoftIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"seqSoftIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    seqSoftIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
